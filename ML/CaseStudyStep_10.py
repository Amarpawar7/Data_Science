...
# plt.legend()              # it displays colour palet for different species
# plt.grid(True)
# plt.show()
...
X_train, X_test, Y_train, Y_test = train_test_split(
    X,
    Y,
    test_size = 0.2,              # if 0.5 and depth will be 5 then eaccuracy will be 90.66666        and if 0.2/0.3 then 100%
    random_state=42                       # shuffling
)



print("Data spliting activituy done")
...
#############################################################################################
# Step 10 : Plot Confuison Matrix
#############################################################################################
print(Border)
print("Step 10 : Plot Confuison Matrix")
print(Border)
