...
#------------------------------------------------------------------------------
#  Function Name  : LoadPreseerveModel()
...
def LoadPreseerveModel(filename):
    Loaded_model = joblib.load(filename)
    print("Model sussefully loaded")
    return Loaded_model
...
def PreserveModel(model,filename):
    ...
    print("\nModel preserved succesfully with name : ",filename)



#------------------------------------------------------------------------------
#  Function Name  : TrainTitanicModel()
#  Description    : It Splits X,Y,training data,testing data
#  Parameters     : df
#  Return         : none
#  Date           : 14/03/2026
#  Author         : Amar Dattatrya Pawar
...
def TrainTitanicModel(df):
    ...
    PreserveModel(model,"MarvellousTitanic.pkl")     # its  an extension file pf binary type

    loaded_model = LoadPreseerveModel("MarvellousTitanic.pkl")
