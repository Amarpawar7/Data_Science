...
def Advertise(Datapath):
    ...
    #----------------------------------------------------------------------------
    # Step 6 : Split dataset into Indempendent & Dependent Variables
    #----------------------------------------------------------------------------
    print(Border)
    print("Step 6 : Split dataset into Indempendent & Dependent Variables")
    print(Border)
    ...
    plt.title("Actual sale vs Predicted sales")
    plt.grid(True)
    plt.show()
