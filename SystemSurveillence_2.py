...
def ProcessScan():
    ...
    for prop in psutil.process_iter():
        try:
            prop.cpu_percent() 
        except:
            pass
    ...
    for proc in psutil.process_iter():
        try:
            ...
            #convert create_time
            try:
                info["create_time"] = time.strftime("%Y-%m-%d %H:%M:%S",time.localtime(info["crete_time"]))
            except:
                info["crete_time"] = "NA"
        ...
        except(psutil.NoSuchProcess, psutil.AccessDenied, psutil.ZombieProcess):                 # zombie process existed by mot now
            pass
...
def main():
    ...
    # python Demo.py 5 Demo
        ...
        print("Press CTRL + C to abort the execution")
